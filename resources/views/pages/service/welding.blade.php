...
@section('title')
<title>Pilar Juanda - Welding</title>
@endsection
...
<section id="page-title" >
    ...
    <div class="container clearfix">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Welding</li>
        </ol>
    </div>
		...
		<section id="slider" class="slider-element slider-parallax swiper_wrapper clearfix" style="height: 600px;">
			...
			<div class="swiper-container swiper-parent">
				<div class="swiper-wrapper">
					<div class="swiper-slide" style="background-image: url('{{asset('sources/images/services/welding/a.jpg')}}');"></div>
					<div class="swiper-slide" style="background-image: url('{{asset('sources/images/services/welding/b.jpg')}}');"></div>
					<div class="swiper-slide" style="background-image: url('{{asset('sources/images/services/welding/c.jpg')}}');"></div>
				</div>
