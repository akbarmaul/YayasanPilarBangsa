...
@section('title')
<title>Pilar Juanda - Teknologi Informasi</title>
@endsection
		...
		<section id="slider" class="slider-element slider-parallax swiper_wrapper clearfix" style="height: 600px;">
			...
			<div class="swiper-container swiper-parent">
				<div class="swiper-wrapper">
					<div class="swiper-slide" style="background-image: url('{{asset('sources/images/services/ti/a.jpg')}}');"></div>
					<div class="swiper-slide" style="background-image: url('{{asset('sources/images/services/ti/b.jpg')}}');"></div>
