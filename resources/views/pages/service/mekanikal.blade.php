...
@section('title')
<title>Pilar Juanda - Mekanikanl dan Elektrikal</title>
@endsection
		...
		<section id="slider" class="slider-element slider-parallax swiper_wrapper clearfix" style="height: 600px;">
			...
			<div class="swiper-container swiper-parent">
				<div class="swiper-wrapper">
					<div class="swiper-slide" style="background-image: url('{{asset('sources/images/services/mekanikal/a.jpg')}}');"></div>
					<div class="swiper-slide" style="background-image: url('{{asset('sources/images/services/mekanikal/b.jpg')}}');"></div>
					<div class="swiper-slide" style="background-image: url('{{asset('sources/images/services/mekanikal/c.jpg')}}');"></div>
				</div>
