...
@section('title')
<title>Pilar Juanda - Konstruksi Bangunan</title>
@endsection
		...
		<section id="slider" class="slider-element slider-parallax swiper_wrapper clearfix" style="height: 600px;">
			...
			<div class="swiper-container swiper-parent">
				<div class="swiper-wrapper">
					<div class="swiper-slide" style="background-image: url('{{asset('sources/images/services/konstruksi/a.jpg')}}');"></div>
					<div class="swiper-slide" style="background-image: url('{{asset('sources/images/services/konstruksi/b.jpg')}}');"></div>
					<div class="swiper-slide" style="background-image: url('{{asset('sources/images/services/konstruksi/c.jpg')}}');"></div>
				</div>
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="col_half">
						...
						<p>Sebagai perusahaan jasa konstruksi rumah dan gedung bertingkat yang berkualitas, kami selalu menghadirkan yang terbaik. Kami juga berkomitmen untuk kepuasan pelanggan dengan menghasilkan kualitas kerja serta pelayanan yang prima.  
                        </p>
